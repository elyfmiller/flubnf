...
|---|---|---|---|---|
| `SIHRS_pop_min.bngl` | production: the Oracle SIHRS filter | Reff, eps1, phi1, mult, r | `app/core/engines/pf.py` (`TEMPLATE`), `app/core/site_build.py` (published verbatim), `/model/pf` in `app/ui/server.py` | `tests/test_min_template.py`, `app/tests/test_natgrowth.py`, `app/tests/test_pages.py` |
